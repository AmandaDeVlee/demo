...
parms <- c(beta=beta, nu=nu,
           ...
           gamma1=gamma1, 
           gamma2=gamma2, 
           gamma3=gamma3, phi=phi, delta1=delta1, delta2=delta2)
           

xstart <- c(S=S_0, E=E_0, A=A_0,I=I_0, H=H_0, R= R_0, V=V_0) # Initial conditions
my.atol <- c(1e-16,1e-16,1e-16,1e-16,1e-16,1e-16,1e-16); # Abs. accuracy - remember to add a term for each equation
